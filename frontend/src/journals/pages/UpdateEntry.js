...
const UpdateEntry = () => {
  ...
  useEffect(() => {
    console.log("[UpdateEntry] fetching entry", entryId);
    const fetchEntry = async () => {
      try {
        ...
        if (!responseData || !responseData.entry) {
          console.log("[UpdateEntry] no entry payload", responseData);
          return;
        }

        console.log("[UpdateEntry] fetch success", responseData.entry);
        ...
        console.log("[UpdateEntry] form seeded");
      } catch (err) {
  ...
  const entryUpdateSubmitHandler = async (event) => {
    ...
    console.log("[UpdateEntry] submit start", {
      entryId,
    ...
    try {
      ...
      console.log("[UpdateEntry] submit success");
    } catch (err) {
      console.log("[UpdateEntry] submit failed", err);
    }
  };
